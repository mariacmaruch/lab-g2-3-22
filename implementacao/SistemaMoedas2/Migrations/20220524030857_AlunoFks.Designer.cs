...
namespace SistemaMoedas2.Migrations
{
    ...
    [Migration("20220524030857_AlunoFks")]
    partial class AlunoFks
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SistemaMoedas2.Models.Aluno", b =>
                {
                    b.HasOne("SistemaMoedas2.Models.Endereco", null)
                        .WithOne()
                        .HasForeignKey("SistemaMoedas2.Models.Aluno", "EnderecoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SistemaMoedas2.Models.Instituicao", null)
                        .WithOne()
                        .HasForeignKey("SistemaMoedas2.Models.Aluno", "InstituicaoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
